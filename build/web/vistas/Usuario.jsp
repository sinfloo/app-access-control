        ...
        <main>
            ...
            <div class="mt-4 contenido">
                <div class="form-group d-flex">                    
                    <h4 class="ml-2 mt-1"><i class="fas fa-address-card"></i> Modulo de Alumnos</h4>
                    <form class="ml-4" action="Controlador?menu=Usuario" method="POST">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="d-flex">                                  
                                        ...
                                        <form class="ml-1" action="Controlador?menu=Usuario" method="POST">
                                            <input type="hidden" name="txtIdUser" value="${us.idUser}">
                                            <input type="hidden" name="txtIdPer" value="${us.id}">
                                            <button class="btn btn-primary btn-sm" type="submit" name="accion" value="VerHistorialPago"><i class="fas fa-eye">Historial</i></button>
                                        </form>                                
                                    </td>
                                </tr>
                            </c:forEach>                        
