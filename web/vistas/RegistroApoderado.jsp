                    ...
                    <div class="card-body">
                        <form action="Controlador?menu=Apoderado" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select  id="mySelector" class="form-control form-control-sm" name="txtIdUser">
                                        <option value="0">*Debe seleccionar para registrar apoderado</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="${Apoderado.nrodoc}" name="txtNroDoc" maxlength="8" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">NOMBRES</label>
                                <div class="col-sm-9">
                                    <input type="text" value="${Apoderado.nombres}" name="txtNombres" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">APELLIDOS</label>
                                <div class="col-sm-9">
                                    <input type="text" value="${Apoderado.apellidos}" name="txtApellidos" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">TELFONO</label>
                                <div class="col-sm-9">
                                    <input type="text" value="${Apoderado.telefono}" name="txtTelefono" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">CORREO</label>
                                <div class="col-sm-9">
                                    <input type="email" value="${Apoderado.correo}" name="txtCorreo" class="form-control form-control-sm">
                                </div>
                            </div>                            
                            <div class="form-group row">
                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm">PARENTESCO</label>
                                <div class="col-sm-9">
                                    <select class="form-control form-control-sm" name="txtParentesco">
                                        <option value="0">SELECCIONAR</option>
